<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <!--footer section start-->
                <footer class="footer">
                    2018 &copy; made by 문희서 양동원 이은별 최보현.
                </footer>
                <!--footer section end-->
                                    ...
                                    <div class="online-chat-container">
                                        ...
                                        <ul class="team-list chat-list-side">
                                            <li>
                                                <a href="#" class="ml-3">
                                                    <span class="thumb-small">
                                                        <img class="rounded-circle" src="/resources/images/users/avatar-1.jpg" alt="">
                                            ...
                                            <li>
                                                <a href="#" class="ml-3">
                                                    <span class="thumb-small">
                                                        <img class="rounded-circle" src="/resources/images/users/avatar-3.jpg" alt="">
                                                        <i class="online dot"></i>
                                                    </span>
                                                    <div class="inline">
                                            ...
                                            <li>
                                                <a href="#" class="ml-3">
                                                    <span class="thumb-small">
                                                        <img class="rounded-circle" src="/resources/images/users/avatar-4.jpg" alt="">
                                                        <i class="away dot"></i>
                                                    </span>
                                                    <div class="inline">
                                            ...
                                            <li>
                                                <a href="#" class="ml-3">
                                                    <span class="thumb-small">
                                                        <img class="rounded-circle" src="/resources/images/users/avatar-5.jpg" alt="">
                                                        <i class="busy dot"></i>
                                                    </span>
                                                    <div class="inline">
                                            ...
                                            <li>
                                                <a href="#" class="ml-3">
                                                    <span class="thumb-small">
                                                        <img class="rounded-circle" src="/resources/images/users/avatar-6.jpg" alt="">
                                                         <i class="online dot"></i>
                                                    </span>
                                                    <div class="inline">
                                        ...
                                        <ul class="list-unstyled friends">
                                            <li>
                                                <a href="#">
                                                    <img class="rounded-circle" src="/resources/images/users/avatar-7.jpg" alt="">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img class="rounded-circle" src="/resources/images/users/avatar-8.jpg" alt="">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img class="rounded-circle" src="/resources/images/users/avatar-9.jpg" alt="">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img class="rounded-circle" src="/resources/images/users/avatar-10.jpg" alt="">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img class="rounded-circle" src="/resources/images/users/avatar-2.jpg" alt="">
                                                </a>
                                            </li>
                                             <li>
                                                <a href="#">
        ...
        <!--plugins js-->
        <script src="/resources/plugins/counter/jquery.counterup.min.js"></script>
        <script src="/resources/plugins/waypoints/jquery.waypoints.min.js"></script>
        <script src="/resources/plugins/sparkline-chart/jquery.sparkline.min.js"></script>
        <script src="/resources/pages/jquery.sparkline.init.js"></script>
        ...
        <script src="/resources/plugins/morris-chart/morris.js"></script>
        <script src="/resources/pages/dashboard-init.js"></script>
